...
- Toggle button updates automatically
...
The website uses Bootstrap's responsive grid system to provide an optimal experience across mobile phones, tablets, laptops and desktop devices.
...
Open `index.html` in your browser or use a local web server such as the VS Code Live Server extension.

---

## Deployment

This project is designed to be deployed easily using **GitHub Pages**.

1. Push the repository to GitHub.
2. Open **Settings → Pages**.
3. Select the `main` branch.
4. Save the configuration.
5. GitHub will publish the website automatically.
...
This project is intended as a personal portfolio and reference implementation.
